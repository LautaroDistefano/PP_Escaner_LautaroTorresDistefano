...
namespace Test
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("        //-----------------------------------------");
            Console.WriteLine();
            Console.WriteLine($"Se puede agregar un libro Igual al escaner ? T: " +
                              $"{escanerLibro + l2}");
            ...
            Console.WriteLine($"Se puede agregar un libro  distinto al escaner ? F: " +
                              $"{escanerLibro + l3}");
            Console.WriteLine("        //-----------------------------------------");
            //-----------------------------------------
